        ...
        <>
                ...
                <div className={`page-options`}>
                    {
                        pageViewType === "overallData" ?
                            ...
                            <>
                                <div className="option">
                                    <button className="btn btn-outline-secondary btn-sm"><i className="fa-solid fa-chevron-left"></i> Back</button>
                                </div>
                            </>
                    }
                </div>
            ...
            <div className="offcanvas offcanvas-end" data-bs-backdrop="static" tabIndex={-1} id="groupLog" aria-labelledby="staticBackdropLabel">
                ...
                <div className="offcanvas-body">
                    ...
                    <div className="col-12 form-group mt-3">
                        <label className="field-required" htmlFor="persons-name">Persons Name</label>
                        {
                            groupFormData.persons.map((person: any, person_ind: number) => (
                                <div className="row align-items-center mb-3" key={person_ind}>
                                    <div className="col-9">
                                        <input type="text" id={"persons-name" + person.id} name={"persons-name" + person.id} className="form-control" placeholder="Enter Remarks"
                                    ...
                                    <div className="col-3">
                                        ...
                                        <button type="button" className="btn btn-outline-secondary btn-sm ng-star-inserted" onClick={() => {
                                            groupFormData.persons.push(createNewPersonObj());
                                            updateGroupFormData({ ...groupFormData })
                                        }}>
